...
describe "Reservations class" do
  ...
  describe "Initializer" do
    before do
      check_in = DateTime.new(2022,5,3.5)
      check_out = DateTime.new(2022,5,5.5)
    ...
    it "tests_overlap" do
      date_in = DateTime.new(2022,5,3.5)
      date_out = date_in + 3
    ...
    it "raises an exception if check in is after check out" do
      date_in = DateTime.new(2022,5,5.5) 
      date_out = DateTime.new(2022,5,3.5)
    ...
    it "raises an exception if neither room or room_id is provided" do
      check_in = DateTime.new(2022,2,3.5)
    ...
    it "correctly calcutates total numbers of nights spent at hotel per reservation" do
      expect(@reservation.total_number_of_nights_per_reservation).must_equal 2
    end
