...
describe "DateRange class" do 
  ...
  describe "#initialize" do
    ...
    it "Raises an ArugmentError if start date is after end date" do 
      ...
      expect{Hotel::DateRange.new("2020-3-20", "2020-3-15")}.must_raise ArgumentError
    end 
    ...
    it "Raises an ArgumentError when the date range is not between current date and end of the year" do 
      ...
      # Act & Assert
      expect{
        Hotel::DateRange.new("2019-12-30", "2020-3-27")
      }.must_raise ArgumentError

      expect{
        Hotel::DateRange.new("0000-3-20", "2020-3-27")
      }.must_raise ArgumentError
    end 
  end 
